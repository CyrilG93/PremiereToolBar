...
const retiredAdjustmentLayerButton = schema.createButton({ actionType: "tool", tool: { id: "addAdjustmentLayer" } });
assert.equal(retiredAdjustmentLayerButton.tool.id, "openSettings");
