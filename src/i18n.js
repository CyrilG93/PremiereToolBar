(function (root) {
  ...
  const messages = {
    ...
    toolAddAdjustmentLayer: "Add Adjustment Layer",
    toolHelp: "Tools are built-in utility commands for clip effects and Adjustment Layers.",
    useSelectedClipRange: "Use selected clip time range",
    defaultTimelineItemDuration: "Default Duration Seconds",
    adjustmentLayerName: "Adjustment Layer Project Name",
    ...
    adjustmentLayerHelp: "Optional: enter the exact Project panel name to use an Adjustment Layer that is not on a timeline. Premiere cannot validate its type until after insertion, and duplicate names are rejected.",
