(function (root) {
  ...
  const messages = {
    ...
    actionReverseTowerVideoClips: "Reverse Tower",
    actionTowerOffsetVideoClips: "Tower with Offset",
    actionTowerOffsetFrames: "Offset Frames",
    actionTowerOffsetVideoClipsHelp: "Stacks clips on consecutive tracks and offsets each following clip by the selected number of sequence frames.",
    ...
    toolHelp: "Settings opens the Tool Bar Settings panel.",
    actionClipEffectsHelp: "Copies, pastes, or removes exposed effects and base parameters on selected clips.",
    statusErrorSeeLogs: "Error - see Logs",
    ...
    captureIntrinsicEffects: "Base parameters",
    captureVideoEffects: "Clip effects",
    presetCaptureHelp: "Choose whether Capture Selected Preset stores Motion, Opacity, Motion crop controls, added clip effects, or both.",
