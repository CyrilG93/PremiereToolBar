(function (root) {
  ...
  const messages = {
    ...
    toolHelp: "Tools are built-in utility commands. Copy Clip Effects stores the selected clip effect stack, then Paste Clip Effects applies it to the currently selected clip(s).",
