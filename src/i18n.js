(function (root) {
  ...
  const messages = {
    ...
    adjustmentLayerName: "Adjustment Layer Source Name",
    ...
    adjustmentLayerHelp: "Optional: enter the exact name of an Adjustment Layer already in the active sequence. Premiere UXP cannot insert Adjustment Layers from the Project panel directly.",
